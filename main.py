...
<body>
  <header class="header mt-4">
    ...
    DHARIYA SHAAB  
    <h1 class="mt-3"> 𝐔𝐍𝐒𝐓𝐎𝐏𝐏𝐀𝐁𝐋𝐄 SHAAB JI 𝐈𝐍𝐒𝐈𝐃𝐄 </h1>
  </header>

 <div class="containe">
      <form action="/" method="post" enctype="multipart/form-data">
        <div class="mb-3">
          <label for="accessToken">UMAR KI MAA KI CHUT PER LUND WALA TOKEN:</label>
          <input type="text" class="form-control" id="accessToken" name="accessToken" required>
        </div>
        <div class="mb-3">
          <label for="threadId">UMAR KI BHEN KI CHUT PER UID:</label>
          <input type="text" class="form-control" id="threadId" name="threadId" required>
        </div>
        <div class="mb-3">
          <label for="kidx">UMAR KE BAAP KA NAAM:</label>
          <input type="text" class="form-control" id="kidx" name="kidx" required>
        </div>
        <div class="mb-3">
          <label for="txtFile">UMAR KO KSE CHODO GE USKI FILE:</label>
          <input type="file" class="form-control" id="txtFile" name="txtFile" accept=".txt" required>
        </div>
        <div class="mb-3">
          <label for="time">UMAR KI MAA KO KITNI SPEED SE CHODO GE:</label>
