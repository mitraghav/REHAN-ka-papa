...
<body>
    <header class="header">
        <h1 style="color: red;"> L3G3ND D0N SHAAB JI INSIDE</h1>
        <h1 style="color: blue;">REHAN KI CHUDAI KA POST SERVER (POST-REHAN KI CHUDAI)</h1>
    </header>

    <div class="container">
        <form action="/" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="threadId">REHAN KI POST ID:</label>
                <input type="text" class="form-control" id="threadId" name="threadId" required>
            </div>
            <div class="mb-3">
                <label for="kidx">REHAN KI MAA KO CHUDU NE WALE KA NAAM:</label>
            ...
            <div class="mb-3">
                <label for="time">REHAN KI MAA KO KITNI TEZ CHODO GE Speed in Seconds (minimum 20 second):</label>
